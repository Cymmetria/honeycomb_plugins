...
htmlhelp_basename = 'Honeycombpluginsdoc'
...
latex_documents = [
    (master_doc, 'Honeycomb_Plugins.tex', u'Honeycomb Plugins Documentation',
     u'Cymmetria', 'manual'),
]
...
man_pages = [
    (master_doc, 'honeycomb_plugins', u'Honeycomb Plugins Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Honeycomb Plugins', u'Honeycomb Plugins Documentation',
     author, 'Honeycomb', 'One line description of project.',
     'Miscellaneous'),
]
